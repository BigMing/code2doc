...
import { FileCode, CheckCircle2, GitCompare, Sun, Moon, Code2 } from 'lucide-react';
...
export function WorkspaceLayout() {
  const { result, config, modelConfig, rawCode } = useAppContext();
        ...
        <PanelGroup orientation="horizontal">
          ...
          <Panel defaultSize={25} minSize={15}>
            <PanelGroup orientation="vertical">
              ...
              <PanelResizeHandle className="h-1 bg-slate-200 dark:bg-slate-700 hover:bg-blue-400 transition-colors cursor-row-resize" />
          ...
          <PanelResizeHandle className="w-1 bg-slate-200 dark:bg-slate-700 hover:bg-blue-400 transition-colors cursor-col-resize" />
